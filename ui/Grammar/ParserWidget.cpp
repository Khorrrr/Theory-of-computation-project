...
void ParserWidget::setupUI() {
    ...
    loadGrammarBtn->setStyleSheet(
        "QPushButton { padding: 6px 15px; font-weight: bold; "
    ...
    productionsGroup->setCheckable(true);
    productionsGroup->setChecked(true);
    ...
    productionsList->setStyleSheet(
        "QListWidget { background-color: #1e1e1e; color: white; border: 1px solid #3e3e3e; }"
    ...
    addProductionBtn->setStyleSheet(
    ...
    QPushButton* deleteProductionBtn = new QPushButton("🗑️ Delete");
    deleteProductionBtn->setStyleSheet(
        "QPushButton { padding: 6px 12px; font-weight: bold; "
    ...
    clearGrammarBtn = new QPushButton("🗑️ Clear All Productions");
    clearGrammarBtn->setStyleSheet(
    ...
    grammarInfoText->setStyleSheet(
        "QTextEdit { background-color: #1e1e1e; color: white; border: 1px solid #3e3e3e; padding: 5px; }"
    );
    ...
    parseOutputText->setMaximumHeight(120);
    parseOutputText->setStyleSheet(
        "QTextEdit { background-color: #1e1e1e; color: white; border: 1px solid #3e3e3e; padding: 5px; }"
    );
